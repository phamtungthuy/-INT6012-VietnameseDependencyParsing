# -*- coding: utf-8 -*-
"""
Triaffine Parser with Multi-Head Biaffine Attention (Ablation Study)

Base: triaffine_parser.py (BiLSTM encoder)
Enhancement: Multi-Head Biaffine Attention instead of single Biaffine
"""
...
class MultiHeadBiaffine(nn.Module):
    """Multi-Head Biaffine Attention for learning diverse relation types."""
...
class TriaffineMultiHead(Model):
    """Triaffine Parser with Multi-Head Biaffine Attention."""
    
    NAME = 'triaffine-multihead'
    ...
    def __init__(
        ...
        n_mlp_arc=500,
        n_mlp_rel=100,
        n_biaffine_heads=4,  # Multi-head parameter
        mlp_dropout=0.33,
        feat_pad_index=0,
        transform=None,
        init_pre_train=False
    ):
        super(TriaffineMultiHead, self).__init__()
        ...
        logger.info(f"[MultiHead] Using Multi-Head Biaffine with {n_biaffine_heads} heads")
